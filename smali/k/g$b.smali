...
.method private i(Landroid/view/MenuItem;)V
    ...
    .line 25
    :cond_8
    iget-object v0, p0, Lk/g$b;->A:Lo0/b;

    if-eqz v0, :cond_9

    .line 26
    invoke-static {p1, v0}, Lo0/h;->a(Landroid/view/MenuItem;Lo0/b;)Landroid/view/MenuItem;

    .line 27
    :cond_9
    iget-object v0, p0, Lk/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lo0/h;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    .line 28
    iget-object v0, p0, Lk/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, Lo0/h;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V
    ...
    invoke-static {p1, v0, v1}, Lo0/h;->b(Landroid/view/MenuItem;CI)V
    ...
    invoke-static {p1, v0, v1}, Lo0/h;->f(Landroid/view/MenuItem;CI)V
    ...
    .line 32
    invoke-static {p1, v0}, Lo0/h;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 34
    invoke-static {p1, v0}, Lo0/h;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public f(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lf/j;->MenuGroup:[I
    ...
    .line 2
    sget v0, Lf/j;->MenuGroup_android_id:I
    ...
    .line 3
    sget v0, Lf/j;->MenuGroup_android_menuCategory:I
    ...
    .line 4
    sget v0, Lf/j;->MenuGroup_android_orderInCategory:I
    ...
    .line 5
    sget v0, Lf/j;->MenuGroup_android_checkableBehavior:I
    ...
    .line 6
    sget v0, Lf/j;->MenuGroup_android_visible:I
    ...
    .line 7
    sget v0, Lf/j;->MenuGroup_android_enabled:I
...
.method public g(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lf/j;->MenuItem:[I

    invoke-static {v0, p1, v1}, Landroidx/appcompat/widget/t0;->t(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/t0;

    move-result-object p1

    .line 2
    sget v0, Lf/j;->MenuItem_android_id:I

    const/4 v1, 0x0

    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/t0;->n(II)I
    ...
    .line 3
    sget v0, Lf/j;->MenuItem_android_menuCategory:I

    iget v2, p0, Lk/g$b;->c:I

    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/t0;->k(II)I

    move-result v0

    .line 4
    sget v2, Lf/j;->MenuItem_android_orderInCategory:I

    iget v3, p0, Lk/g$b;->d:I

    invoke-virtual {p1, v2, v3}, Landroidx/appcompat/widget/t0;->k(II)I
    ...
    .line 6
    sget v0, Lf/j;->MenuItem_android_title:I

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/t0;->p(I)Ljava/lang/CharSequence;
    ...
    .line 7
    sget v0, Lf/j;->MenuItem_android_titleCondensed:I
    ...
    .line 8
    sget v0, Lf/j;->MenuItem_android_icon:I
    ...
    .line 9
    sget v0, Lf/j;->MenuItem_android_alphabeticShortcut:I

    .line 10
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/t0;->o(I)Ljava/lang/String;
    ...
    .line 11
    sget v0, Lf/j;->MenuItem_alphabeticModifiers:I
    ...
    .line 13
    sget v0, Lf/j;->MenuItem_android_numericShortcut:I
    ...
    .line 15
    sget v0, Lf/j;->MenuItem_numericModifiers:I
    ...
    .line 17
    sget v0, Lf/j;->MenuItem_android_checkable:I

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/t0;->r(I)Z
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/t0;->a(IZ)Z
    ...
    .line 20
    :goto_0
    sget v0, Lf/j;->MenuItem_android_checked:I
    ...
    .line 21
    sget v0, Lf/j;->MenuItem_android_visible:I

    iget-boolean v2, p0, Lk/g$b;->f:Z

    invoke-virtual {p1, v0, v2}, Landroidx/appcompat/widget/t0;->a(IZ)Z
    ...
    .line 22
    sget v0, Lf/j;->MenuItem_android_enabled:I
    ...
    .line 23
    sget v0, Lf/j;->MenuItem_showAsAction:I
    ...
    .line 24
    sget v0, Lf/j;->MenuItem_android_onClick:I
    ...
    .line 25
    sget v0, Lf/j;->MenuItem_actionLayout:I
    ...
    .line 26
    sget v0, Lf/j;->MenuItem_actionViewClass:I
    ...
    .line 27
    sget v0, Lf/j;->MenuItem_actionProviderClass:I
    ...
    .line 28
    iget v4, p0, Lk/g$b;->w:I

    if-nez v4, :cond_2

    iget-object v4, p0, Lk/g$b;->x:Ljava/lang/String;
    ...
    sget-object v4, Lk/g;->f:[Ljava/lang/Class;

    iget-object v5, p0, Lk/g$b;->F:Lk/g;

    iget-object v5, v5, Lk/g;->b:[Ljava/lang/Object;

    invoke-direct {p0, v0, v4, v5}, Lk/g$b;->e(Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lo0/b;

    iput-object v0, p0, Lk/g$b;->A:Lo0/b;

    goto :goto_2

    .line 30
    :cond_2
    iput-object v3, p0, Lk/g$b;->A:Lo0/b;

    .line 31
    :goto_2
    sget v0, Lf/j;->MenuItem_contentDescription:I
    ...
    .line 32
    sget v0, Lf/j;->MenuItem_tooltipText:I
    ...
    .line 33
    sget v0, Lf/j;->MenuItem_iconTintMode:I
    ...
    .line 35
    :cond_3
    iput-object v3, p0, Lk/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    .line 36
    :goto_3
    sget v0, Lf/j;->MenuItem_iconTint:I
    ...
    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/t0;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 38
    :cond_4
    iput-object v3, p0, Lk/g$b;->D:Landroid/content/res/ColorStateList;
