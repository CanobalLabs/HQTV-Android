...
# instance fields
.field protected volatile a:Lh1/b;
...
.method public c()V
    ...
    .line 2
    iget-object v0, p0, Landroidx/room/i;->c:Lh1/c;
    ...
    invoke-virtual {v1, v0}, Landroidx/room/f;->m(Lh1/b;)V

    .line 4
    invoke-interface {v0}, Lh1/b;->beginTransaction()V
...
.method public d(Ljava/lang/String;)Lh1/f;
    ...
    invoke-interface {v0, p1}, Lh1/b;->t(Ljava/lang/String;)Lh1/f;
...
.method protected abstract f(Landroidx/room/a;)Lh1/c;
.end method
...
.method public g()V
    ...
    invoke-interface {v0}, Lh1/b;->endTransaction()V
...
.method public k()Z
    ...
    invoke-interface {v0}, Lh1/b;->inTransaction()Z
...
.method public l(Landroidx/room/a;)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/room/i;->f(Landroidx/room/a;)Lh1/c;

    move-result-object v0

    iput-object v0, p0, Landroidx/room/i;->c:Lh1/c;
    ...
    sget-object v2, Landroidx/room/i$c;->WRITE_AHEAD_LOGGING:Landroidx/room/i$c;
    ...
    invoke-interface {v0, v1}, Lh1/c;->a(Z)V
...
.method protected m(Lh1/b;)V
    .locals 1

    .line 1
    iget-object v0, p0, Landroidx/room/i;->d:Landroidx/room/f;

    invoke-virtual {v0, p1}, Landroidx/room/f;->d(Lh1/b;)V
...
.method public o()Z
    ...
    .line 1
    iget-object v0, p0, Landroidx/room/i;->a:Lh1/b;

    if-eqz v0, :cond_0

    .line 2
    invoke-interface {v0}, Lh1/b;->isOpen()Z
...
.method public p(Lh1/e;)Landroid/database/Cursor;
    .locals 1
    ...
    invoke-interface {v0, p1}, Lh1/b;->l(Lh1/e;)Landroid/database/Cursor;
...
.method public q()V
    ...
    invoke-interface {v0}, Lh1/b;->setTransactionSuccessful()V
