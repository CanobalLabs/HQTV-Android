.class public abstract Landroidx/recyclerview/widget/l$f;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Landroidx/recyclerview/widget/l$f$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/l$f$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/l$f;->b:Landroid/view/animation/Interpolator;

    .line 2
    new-instance v0, Landroidx/recyclerview/widget/l$f$b;

    invoke-direct {v0}, Landroidx/recyclerview/widget/l$f$b;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/l$f;->c:Landroid/view/animation/Interpolator;
...
.method public constructor <init>()V
    ...
    .line 2
    iput v0, p0, Landroidx/recyclerview/widget/l$f;->a:I
...
.method private i(Landroidx/recyclerview/widget/RecyclerView;)I
    ...
    .line 1
    iget v0, p0, Landroidx/recyclerview/widget/l$f;->a:I
    ...
    sget v0, Le1/b;->item_touch_helper_max_drag_scroll_per_frame:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p1

    iput p1, p0, Landroidx/recyclerview/widget/l$f;->a:I

    .line 3
    :cond_0
    iget p1, p0, Landroidx/recyclerview/widget/l$f;->a:I
...
.method public static t(II)I
    ...
    .line 1
    invoke-static {v1, v0}, Landroidx/recyclerview/widget/l$f;->s(II)I
    ...
    .line 2
    invoke-static {v1, p1}, Landroidx/recyclerview/widget/l$f;->s(II)I
    ...
    .line 3
    invoke-static {v0, p0}, Landroidx/recyclerview/widget/l$f;->s(II)I
...
.method final f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/l$f;->k(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
    ...
    invoke-virtual {p0, p2, p1}, Landroidx/recyclerview/widget/l$f;->d(II)I
...
.method o(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)Z
    ...
    .line 1
    invoke-virtual {p0, p1, p2}, Landroidx/recyclerview/widget/l$f;->f(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)I
...
.method public p(Landroidx/recyclerview/widget/RecyclerView;IIIJ)I
    ...
    .line 1
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/l$f;->i(Landroidx/recyclerview/widget/RecyclerView;)I
    ...
    .line 5
    sget-object p4, Landroidx/recyclerview/widget/l$f;->c:Landroid/view/animation/Interpolator;
    ...
    .line 7
    sget-object p2, Landroidx/recyclerview/widget/l$f;->b:Landroid/view/animation/Interpolator;
...
.method w(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
    ...
    check-cast v0, Landroidx/recyclerview/widget/l$h;

    .line 3
    invoke-virtual {v0}, Landroidx/recyclerview/widget/l$h;->e()V
    ...
    .line 5
    iget-object v3, v0, Landroidx/recyclerview/widget/l$h;->e:Landroidx/recyclerview/widget/RecyclerView$d0;

    iget v4, v0, Landroidx/recyclerview/widget/l$h;->i:F

    iget v5, v0, Landroidx/recyclerview/widget/l$h;->j:F

    iget v6, v0, Landroidx/recyclerview/widget/l$h;->f:I
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/recyclerview/widget/l$f;->u(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
...
.method x(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;Ljava/util/List;IFF)V
    ...
    invoke-virtual/range {v0 .. v7}, Landroidx/recyclerview/widget/l$f;->v(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;FFIZ)V
    ...
    .line 10
    iget-boolean v2, v1, Landroidx/recyclerview/widget/l$h;->l:Z

    if-eqz v2, :cond_2

    iget-boolean v2, v1, Landroidx/recyclerview/widget/l$h;->h:Z
    ...
    .line 12
    :cond_2
    iget-boolean v1, v1, Landroidx/recyclerview/widget/l$h;->l:Z
...
.method public z(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;ILandroidx/recyclerview/widget/RecyclerView$d0;III)V
    ...
    .line 2
    instance-of v0, p3, Landroidx/recyclerview/widget/l$j;

    if-eqz v0, :cond_0

    .line 3
    check-cast p3, Landroidx/recyclerview/widget/l$j;
    ...
    invoke-interface {p3, p1, p2, p6, p7}, Landroidx/recyclerview/widget/l$j;->b(Landroid/view/View;Landroid/view/View;II)V

    return-void

    .line 4
    :cond_0
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$o;->l()Z
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$o;->R(Landroid/view/View;)I
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$o;->U(Landroid/view/View;)I
    ...
    .line 11
    :cond_2
    invoke-virtual {p3}, Landroidx/recyclerview/widget/RecyclerView$o;->m()Z
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$o;->V(Landroid/view/View;)I
    ...
    invoke-virtual {p3, p2}, Landroidx/recyclerview/widget/RecyclerView$o;->P(Landroid/view/View;)I
