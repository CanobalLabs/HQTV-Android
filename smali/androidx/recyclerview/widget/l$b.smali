...
.method public a(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/l;->z:Lo0/c;

    invoke-virtual {p1, p2}, Lo0/c;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v3, v2, Landroidx/recyclerview/widget/l;->c:Landroidx/recyclerview/widget/RecyclerView$d0;
    ...
    invoke-virtual {v0, p2, v1, p1}, Landroidx/recyclerview/widget/l;->F(Landroid/view/MotionEvent;II)V
    ...
    invoke-virtual {v2, p2, p1, v1}, Landroidx/recyclerview/widget/l;->F(Landroid/view/MotionEvent;II)V

    .line 17
    iget-object p1, p0, Landroidx/recyclerview/widget/l$b;->a:Landroidx/recyclerview/widget/l;

    invoke-virtual {p1, v3}, Landroidx/recyclerview/widget/l;->t(Landroidx/recyclerview/widget/RecyclerView$d0;)V
    ...
    invoke-virtual {p1, p2, v4}, Landroidx/recyclerview/widget/l;->z(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
...
.method public c(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p1, Landroidx/recyclerview/widget/l;->c:Landroidx/recyclerview/widget/RecyclerView$d0;

    if-nez v2, :cond_4

    .line 8
    invoke-virtual {p1, p2}, Landroidx/recyclerview/widget/l;->m(Landroid/view/MotionEvent;)Landroidx/recyclerview/widget/l$h;
    ...
    iget v4, p1, Landroidx/recyclerview/widget/l$h;->i:F
    ...
    iget v4, p1, Landroidx/recyclerview/widget/l$h;->j:F
    ...
    .line 11
    iget-object v3, p1, Landroidx/recyclerview/widget/l$h;->e:Landroidx/recyclerview/widget/RecyclerView$d0;

    invoke-virtual {v2, v3, v0}, Landroidx/recyclerview/widget/l;->l(Landroidx/recyclerview/widget/RecyclerView$d0;Z)V
    ...
    iget-object v3, v2, Landroidx/recyclerview/widget/l;->m:Landroidx/recyclerview/widget/l$f;

    iget-object v2, v2, Landroidx/recyclerview/widget/l;->r:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v4, p1, Landroidx/recyclerview/widget/l$h;->e:Landroidx/recyclerview/widget/RecyclerView$d0;

    invoke-virtual {v3, v2, v4}, Landroidx/recyclerview/widget/l$f;->c(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$d0;)V
    ...
    iget p1, p1, Landroidx/recyclerview/widget/l$h;->f:I

    invoke-virtual {v2, v3, p1}, Landroidx/recyclerview/widget/l;->z(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    ...
    invoke-virtual {p1, p2, v2, v1}, Landroidx/recyclerview/widget/l;->F(Landroid/view/MotionEvent;II)V
    ...
    .line 20
    invoke-virtual {p1, v2, v1}, Landroidx/recyclerview/widget/l;->z(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/l;->c:Landroidx/recyclerview/widget/RecyclerView$d0;
...
.method public e(Z)V
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/recyclerview/widget/l;->z(Landroidx/recyclerview/widget/RecyclerView$d0;I)V
