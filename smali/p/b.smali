...
# direct methods
.method constructor <init>(Ld/b;Landroid/content/ComponentName;)V
    .locals 0
...
.method public c(Lp/a;)Lp/e;
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Lp/b;->a:Ld/b;

    invoke-interface {v1, v0}, Ld/b;->h0(Ld/a;)Z
    ...
    invoke-direct {p1, v1, v0, v2}, Lp/e;-><init>(Ld/b;Ld/a;Landroid/content/ComponentName;)V
...
.method public d(J)Z
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lp/b;->a:Ld/b;

    invoke-interface {v0, p1, p2}, Ld/b;->c0(J)Z
