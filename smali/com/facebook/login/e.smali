...
.method public static declared-synchronized q()Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    .locals 3
    ...
    .line 1
    :try_start_0
    sget-object v1, Lcom/facebook/login/e;->g:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
    ...
    sput-object v1, Lcom/facebook/login/e;->g:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method private u(Lcom/facebook/login/k$d;)V
    .locals 3
    ...
    .line 3
    :cond_0
    invoke-virtual {p0}, Lcom/facebook/login/e;->p()Lcom/facebook/login/d;
    ...
    invoke-virtual {v1, v0, v2}, Landroidx/fragment/app/c;->show(Landroidx/fragment/app/i;Ljava/lang/String;)V

    .line 5
    invoke-virtual {v1, p1}, Lcom/facebook/login/d;->L(Lcom/facebook/login/k$d;)V
...
.method o(Lcom/facebook/login/k$d;)I
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/facebook/login/e;->u(Lcom/facebook/login/k$d;)V
...
.method protected p()Lcom/facebook/login/d;
    .locals 1
...
.method public r()V
    ...
    .line 3
    invoke-static {v0, v1}, Lcom/facebook/login/k$e;->a(Lcom/facebook/login/k$d;Ljava/lang/String;)Lcom/facebook/login/k$e;
    ...
    invoke-virtual {v1, v0}, Lcom/facebook/login/k;->h(Lcom/facebook/login/k$e;)V
...
.method public s(Ljava/lang/Exception;)V
    ...
    invoke-virtual {v0, p1}, Lcom/facebook/login/k;->h(Lcom/facebook/login/k$e;)V
...
.method public t(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Collection;Ljava/util/Collection;Ljava/util/Collection;Lcom/facebook/d;Ljava/util/Date;Ljava/util/Date;Ljava/util/Date;)V
    ...
    .line 2
    iget-object v1, v0, Lcom/facebook/login/o;->f:Lcom/facebook/login/k;

    .line 3
    invoke-virtual {v1}, Lcom/facebook/login/k;->r()Lcom/facebook/login/k$d;

    move-result-object v1

    invoke-static {v1, v12}, Lcom/facebook/login/k$e;->d(Lcom/facebook/login/k$d;Lcom/facebook/a;)Lcom/facebook/login/k$e;

    move-result-object v1

    .line 4
    iget-object v2, v0, Lcom/facebook/login/o;->f:Lcom/facebook/login/k;

    invoke-virtual {v2, v1}, Lcom/facebook/login/k;->h(Lcom/facebook/login/k$e;)V
