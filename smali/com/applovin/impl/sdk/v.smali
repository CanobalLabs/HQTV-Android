...
# direct methods
.method public constructor <init>(Lcom/applovin/mediation/ads/MaxAdView;Lcom/applovin/impl/sdk/i;Lcom/applovin/impl/sdk/v$c;)V
    .locals 2
    ...
    new-instance p2, Lcom/applovin/impl/sdk/v$a;

    invoke-direct {p2, p0, p1, p3}, Lcom/applovin/impl/sdk/v$a;-><init>(Lcom/applovin/impl/sdk/v;Lcom/applovin/mediation/ads/MaxAdView;Lcom/applovin/impl/sdk/v$c;)V

    iput-object p2, p0, Lcom/applovin/impl/sdk/v;->e:Ljava/lang/Runnable;

    new-instance p1, Lcom/applovin/impl/sdk/v$b;

    invoke-direct {p1, p0}, Lcom/applovin/impl/sdk/v$b;-><init>(Lcom/applovin/impl/sdk/v;)V
...
.method private c(Landroid/content/Context;Landroid/view/View;)V
    ...
    invoke-static {p1, p2}, Lcom/applovin/impl/sdk/utils/p;->h(Landroid/content/Context;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-virtual {p1, p2, v0}, Lcom/applovin/impl/sdk/o;->j(Ljava/lang/String;Ljava/lang/String;)V
...
.method private e(Landroid/view/View;Landroid/view/View;)Z
    .locals 4
...
.method static synthetic f(Lcom/applovin/impl/sdk/v;Landroid/view/View;Landroid/view/View;)Z
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/applovin/impl/sdk/v;->i(Landroid/view/View;Landroid/view/View;)Z
...
.method private g()V
    ...
    sget-object v3, Lcom/applovin/impl/sdk/b$e;->n1:Lcom/applovin/impl/sdk/b$e;
...
.method static synthetic h(Lcom/applovin/impl/sdk/v;)V
    .locals 0
...
.method private i(Landroid/view/View;Landroid/view/View;)Z
    .locals 4

    invoke-direct {p0, p1, p2}, Lcom/applovin/impl/sdk/v;->e(Landroid/view/View;Landroid/view/View;)Z
...
.method public d(Landroid/content/Context;Lcom/applovin/impl/mediation/b$c;)V
    .locals 3
    ...
    :try_start_0
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/v;->b()V

    invoke-virtual {p2}, Lcom/applovin/impl/mediation/b$c;->Y()Landroid/view/View;

    move-result-object v1

    iput-object v1, p0, Lcom/applovin/impl/sdk/v;->h:Landroid/view/View;

    invoke-virtual {p2}, Lcom/applovin/impl/mediation/b$c;->d0()I

    move-result v1

    iput v1, p0, Lcom/applovin/impl/sdk/v;->i:I

    invoke-virtual {p2}, Lcom/applovin/impl/mediation/b$c;->f0()J
    ...
    invoke-direct {p0, p1, p2}, Lcom/applovin/impl/sdk/v;->c(Landroid/content/Context;Landroid/view/View;)V
