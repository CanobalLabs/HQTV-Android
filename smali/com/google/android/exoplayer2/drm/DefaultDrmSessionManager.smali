...
# direct methods
.method static synthetic f(Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;)Ljava/util/List;
    .locals 0
...
.method private i(Ljava/util/List;Z)Lcom/google/android/exoplayer2/drm/DefaultDrmSession;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v10, v0, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->k:Lcom/google/android/exoplayer2/upstream/p;
...
.method private static j(Lcom/google/android/exoplayer2/drm/i;Ljava/util/UUID;Z)Ljava/util/List;
    ...
    iget v1, p0, Lcom/google/android/exoplayer2/drm/i;->h:I
    ...
    .line 2
    :goto_0
    iget v3, p0, Lcom/google/android/exoplayer2/drm/i;->h:I

    if-ge v2, v3, :cond_4

    .line 3
    invoke-virtual {p0, v2}, Lcom/google/android/exoplayer2/drm/i;->e(I)Lcom/google/android/exoplayer2/drm/i$b;

    move-result-object v3

    .line 4
    invoke-virtual {v3, p1}, Lcom/google/android/exoplayer2/drm/i$b;->d(Ljava/util/UUID;)Z

    move-result v4

    if-nez v4, :cond_1

    sget-object v4, Lcom/google/android/exoplayer2/u;->c:Ljava/util/UUID;
    ...
    sget-object v4, Lcom/google/android/exoplayer2/u;->b:Ljava/util/UUID;

    invoke-virtual {v3, v4}, Lcom/google/android/exoplayer2/drm/i$b;->d(Ljava/util/UUID;)Z
    ...
    .line 6
    iget-object v4, v3, Lcom/google/android/exoplayer2/drm/i$b;->i:[B
...
.method public static synthetic k(Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->n(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)V

    return-void
.end method

.method static synthetic l(Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager$MissingSchemeDataException;Lcom/google/android/exoplayer2/drm/h;)V
    .locals 0

    .line 1
    invoke-interface {p1, p0}, Lcom/google/android/exoplayer2/drm/h;->k(Ljava/lang/Exception;)V

    return-void
.end method

.method private m(Landroid/os/Looper;)V
    .locals 1
...
.method private n(Lcom/google/android/exoplayer2/drm/DefaultDrmSession;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/drm/DefaultDrmSession;->v()V
...
# virtual methods
.method public a(Lcom/google/android/exoplayer2/drm/i;)Z
    .locals 4
    ...
    invoke-static {p1, v0, v1}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->j(Lcom/google/android/exoplayer2/drm/i;Ljava/util/UUID;Z)Ljava/util/List;
    ...
    .line 4
    iget v0, p1, Lcom/google/android/exoplayer2/drm/i;->h:I

    if-ne v0, v1, :cond_1

    invoke-virtual {p1, v2}, Lcom/google/android/exoplayer2/drm/i;->e(I)Lcom/google/android/exoplayer2/drm/i$b;

    move-result-object v0

    sget-object v3, Lcom/google/android/exoplayer2/u;->b:Ljava/util/UUID;

    invoke-virtual {v0, v3}, Lcom/google/android/exoplayer2/drm/i$b;->d(Ljava/util/UUID;)Z
    ...
    :cond_2
    :goto_0
    iget-object p1, p1, Lcom/google/android/exoplayer2/drm/i;->g:Ljava/lang/String;
...
.method public b(Lcom/google/android/exoplayer2/drm/i;)Ljava/lang/Class;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->a(Lcom/google/android/exoplayer2/drm/i;)Z
    ...
    invoke-interface {p1}, Lcom/google/android/exoplayer2/drm/o;->a()Ljava/lang/Class;
...
.method public final c()V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/exoplayer2/drm/o;->g(Lcom/google/android/exoplayer2/drm/o$b;)V
...
.method public d(Landroid/os/Looper;I)Lcom/google/android/exoplayer2/drm/DrmSession;
    ...
    .line 1
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->h(Landroid/os/Looper;)V
    ...
    .line 4
    invoke-interface {v0}, Lcom/google/android/exoplayer2/drm/o;->a()Ljava/lang/Class;
    ...
    .line 6
    invoke-static {v1, p2}, Lcom/google/android/exoplayer2/util/g0;->c0([II)I
    ...
    .line 8
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->m(Landroid/os/Looper;)V
    ...
    .line 11
    invoke-direct {p0, p1, v2}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->i(Ljava/util/List;Z)Lcom/google/android/exoplayer2/drm/DefaultDrmSession;
...
.method public e(Landroid/os/Looper;Lcom/google/android/exoplayer2/drm/i;)Lcom/google/android/exoplayer2/drm/DrmSession;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p2, p1, v0}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->j(Lcom/google/android/exoplayer2/drm/i;Ljava/util/UUID;Z)Ljava/util/List;
    ...
    .line 13
    invoke-direct {p0, p1, v0}, Lcom/google/android/exoplayer2/drm/DefaultDrmSessionManager;->i(Ljava/util/List;Z)Lcom/google/android/exoplayer2/drm/DefaultDrmSession;
...
.method public final g(Landroid/os/Handler;Lcom/google/android/exoplayer2/drm/h;)V
    .locals 1
