...
.method private p(Ljava/nio/ByteBuffer;)V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer2/audio/p;->k(I)Ljava/nio/ByteBuffer;
...
.method private q([BI)V
    ...
    .line 1
    invoke-virtual {p0, p2}, Lcom/google/android/exoplayer2/audio/p;->k(I)Ljava/nio/ByteBuffer;
...
.method private r(Ljava/nio/ByteBuffer;)V
    ...
    .line 2
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/audio/v;->n(Ljava/nio/ByteBuffer;)I
    ...
    .line 5
    invoke-direct {p0, v3, v5}, Lcom/google/android/exoplayer2/audio/v;->q([BI)V
    ...
    invoke-direct {p0, v1, v2}, Lcom/google/android/exoplayer2/audio/v;->q([BI)V
    ...
    invoke-direct {p0, p1, v1, v2}, Lcom/google/android/exoplayer2/audio/v;->v(Ljava/nio/ByteBuffer;[BI)V
...
.method private s(Ljava/nio/ByteBuffer;)V
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/audio/v;->m(Ljava/nio/ByteBuffer;)I
    ...
    .line 7
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/audio/v;->p(Ljava/nio/ByteBuffer;)V
...
.method private t(Ljava/nio/ByteBuffer;)V
    ...
    invoke-direct {p0, p1, v2, v3}, Lcom/google/android/exoplayer2/audio/v;->v(Ljava/nio/ByteBuffer;[BI)V
...
.method public b(Ljava/nio/ByteBuffer;)V
    ...
    .line 3
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/audio/v;->t(Ljava/nio/ByteBuffer;)V
    ...
    .line 5
    :cond_1
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/audio/v;->r(Ljava/nio/ByteBuffer;)V

    goto :goto_0

    .line 6
    :cond_2
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/audio/v;->s(Ljava/nio/ByteBuffer;)V
...
.method protected h()V
    ...
    .line 3
    invoke-direct {p0, v0, v1}, Lcom/google/android/exoplayer2/audio/v;->l(J)I
...
.method protected i()V
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/android/exoplayer2/audio/v;->q([BI)V
