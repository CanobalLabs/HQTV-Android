...
.field public final h:Lcom/google/android/exoplayer2/e0;
...
.method public constructor <init>(Ljava/lang/String;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/google/android/exoplayer2/e0;Ljava/util/List;ZLjava/util/Map;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-static {p3, p4, p5, p6, p7}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->f(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 9
    iput-object p8, p0, Lcom/google/android/exoplayer2/source/hls/playlist/e;->h:Lcom/google/android/exoplayer2/e0;
...
.method private static d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 6
    iget v6, v5, Lcom/google/android/exoplayer2/offline/c;->f:I

    if-ne v6, p1, :cond_0

    iget v5, v5, Lcom/google/android/exoplayer2/offline/c;->g:I
...
.method public static e(Ljava/lang/String;)Lcom/google/android/exoplayer2/source/hls/playlist/e;
    .locals 13
...
.method private static f(Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    .line 6
    :cond_1
    invoke-static {p1, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->b(Ljava/util/List;Ljava/util/List;)V

    .line 7
    invoke-static {p2, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->b(Ljava/util/List;Ljava/util/List;)V

    .line 8
    invoke-static {p3, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->b(Ljava/util/List;Ljava/util/List;)V

    .line 9
    invoke-static {p4, v0}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->b(Ljava/util/List;Ljava/util/List;)V
...
.method public bridge synthetic a(Ljava/util/List;)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->c(Ljava/util/List;)Lcom/google/android/exoplayer2/source/hls/playlist/e;
...
.method public c(Ljava/util/List;)Lcom/google/android/exoplayer2/source/hls/playlist/e;
    .locals 14
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    invoke-static {v0, v3, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 4
    invoke-static {v0, v5, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    .line 5
    invoke-static {v0, v6, p1}, Lcom/google/android/exoplayer2/source/hls/playlist/e;->d(Ljava/util/List;ILjava/util/List;)Ljava/util/List;
    ...
    iget-object v8, p0, Lcom/google/android/exoplayer2/source/hls/playlist/e;->h:Lcom/google/android/exoplayer2/e0;
