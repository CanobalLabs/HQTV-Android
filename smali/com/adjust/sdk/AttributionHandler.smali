...
.method static synthetic access$700(Lcom/adjust/sdk/AttributionHandler;Ljava/lang/String;)Z
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lcom/adjust/sdk/AttributionHandler;->sendAttributionRequestI(Ljava/lang/String;)Z
...
.method private sendAttributionRequestI(Ljava/lang/String;)Z
    .locals 6
    ...
    .line 3
    iget-object p1, p0, Lcom/adjust/sdk/AttributionHandler;->logger:Lcom/adjust/sdk/ILogger;
    ...
    invoke-interface {v3, v5, v4}, Lcom/adjust/sdk/ILogger;->verbose(Ljava/lang/String;[Ljava/lang/Object;)V

    .line 6
    :try_start_0
    iget-object v3, p0, Lcom/adjust/sdk/AttributionHandler;->basePath:Ljava/lang/String;

    invoke-static {v0, v3, p1}, Lcom/adjust/sdk/UtilNetworking;->createGETHttpsURLConnection(Lcom/adjust/sdk/ActivityPackage;Ljava/lang/String;Ljava/lang/String;)Lcom/adjust/sdk/ResponseData;

    move-result-object p1

    .line 7
    instance-of v0, p1, Lcom/adjust/sdk/AttributionResponseData;
    ...
    .line 8
    :cond_2
    iget-object v0, p1, Lcom/adjust/sdk/ResponseData;->trackingState:Lcom/adjust/sdk/TrackingState;
    ...
    .line 9
    iget-object p1, p0, Lcom/adjust/sdk/AttributionHandler;->activityHandlerWeakRef:Ljava/lang/ref/WeakReference;

    invoke-virtual {p1}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/adjust/sdk/IActivityHandler;

    invoke-interface {p1}, Lcom/adjust/sdk/IActivityHandler;->gotOptOutResponse()V

    return v1

    .line 10
    :cond_3
    check-cast p1, Lcom/adjust/sdk/AttributionResponseData;

    invoke-virtual {p0, p1}, Lcom/adjust/sdk/AttributionHandler;->checkAttributionResponse(Lcom/adjust/sdk/AttributionResponseData;)V
    :try_end_0
    ...
    const-string p1, "Failed to get attribution (%s)"
