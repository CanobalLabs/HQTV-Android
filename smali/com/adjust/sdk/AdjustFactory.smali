...
.field private static fallbackBaseUrls:Ljava/util/List; = null
...
.field private static fallbackGdprUrls:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static fallbackSubscriptionUrls:Ljava/util/List; = null
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/String;",
...
.field private static tryInstallReferrer:Z
...
.method static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lcom/adjust/sdk/Constants;->FALLBACK_BASE_URLS:[Ljava/lang/String;

    invoke-static {v0}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/adjust/sdk/AdjustFactory;->fallbackBaseUrls:Ljava/util/List;

    .line 2
    sget-object v0, Lcom/adjust/sdk/Constants;->FALLBACK_GDPR_URLS:[Ljava/lang/String;

    invoke-static {v0}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/adjust/sdk/AdjustFactory;->fallbackGdprUrls:Ljava/util/List;

    .line 3
    sget-object v0, Lcom/adjust/sdk/Constants;->FALLBACK_SUBSCRIPTION_URLS:[Ljava/lang/String;

    invoke-static {v0}, Ljava/util/Arrays;->asList([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    sput-object v0, Lcom/adjust/sdk/AdjustFactory;->fallbackSubscriptionUrls:Ljava/util/List;
...
.method public static getFallbackBaseUrls()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    sget-object v0, Lcom/adjust/sdk/AdjustFactory;->fallbackBaseUrls:Ljava/util/List;
...
.method public static getFallbackGdprUrls()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    sget-object v0, Lcom/adjust/sdk/AdjustFactory;->fallbackGdprUrls:Ljava/util/List;
...
.method public static getFallbackSubscriptionUrls()Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 1
    sget-object v0, Lcom/adjust/sdk/AdjustFactory;->fallbackSubscriptionUrls:Ljava/util/List;
...
.method public static setFallbackBaseUrls(Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    sput-object p0, Lcom/adjust/sdk/AdjustFactory;->fallbackBaseUrls:Ljava/util/List;

    return-void
.end method

.method public static setFallbackGdprUrls(Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    sput-object p0, Lcom/adjust/sdk/AdjustFactory;->fallbackGdprUrls:Ljava/util/List;

    return-void
.end method

.method public static setFallbackSubscriptionUrls(Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    sput-object p0, Lcom/adjust/sdk/AdjustFactory;->fallbackSubscriptionUrls:Ljava/util/List;
