...
.field public static final g:Lkotlinx/coroutines/h;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/h;->g:Lkotlinx/coroutines/h;
    ...
    .line 3
    invoke-static {v0}, Lxc/g;->f(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    .line 7
    :goto_1
    sput v0, Lkotlinx/coroutines/h;->e:I
...
.method private final D()Ljava/util/concurrent/ExecutorService;
    ...
    .line 2
    invoke-direct {p0}, Lkotlinx/coroutines/h;->G()I
...
.method private final E()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/h;->D()Ljava/util/concurrent/ExecutorService;
    ...
    .line 3
    sget-boolean v2, Lkotlinx/coroutines/h;->f:Z

    const/4 v3, 0x0

    if-nez v2, :cond_4

    sget v2, Lkotlinx/coroutines/h;->e:I
    ...
    .line 5
    sget-object v4, Lkotlinx/coroutines/h;->g:Lkotlinx/coroutines/h;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/h;->H(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/h;->G()I
...
.method private final declared-synchronized F()Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/h;->E()Ljava/util/concurrent/ExecutorService;

    move-result-object v0

    sput-object v0, Lkotlinx/coroutines/h;->pool:Ljava/util/concurrent/Executor;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private final G()I
    ...
    .line 1
    sget v0, Lkotlinx/coroutines/h;->e:I
    ...
    invoke-static {v0, v2}, Luc/g;->a(II)I
...
.method public B(Lkc/g;Ljava/lang/Runnable;)V
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/h;->F()Ljava/util/concurrent/Executor;
    ...
    invoke-interface {v0, p2}, Lkotlinx/coroutines/f1;->f(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 3
    sget-object p1, Lkotlinx/coroutines/w;->k:Lkotlinx/coroutines/w;

    invoke-virtual {p1, p2}, Lkotlinx/coroutines/f0;->P(Ljava/lang/Runnable;)V
...
.method public final H(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    .line 1
    sget-object v0, Lkotlinx/coroutines/h$b;->e:Lkotlinx/coroutines/h$b;
