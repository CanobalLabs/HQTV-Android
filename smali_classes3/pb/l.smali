...
.method public constructor <init>(Ldb/f;JLjava/util/concurrent/TimeUnit;Ldb/w;)V
    ...
    .line 2
    iput-wide p2, p0, Lpb/l;->g:J

    .line 3
    iput-object p4, p0, Lpb/l;->h:Ljava/util/concurrent/TimeUnit;

    .line 4
    iput-object p5, p0, Lpb/l;->i:Ldb/w;
...
.method protected n1(Lbd/c;)V
    ...
    new-instance v7, Lpb/l$b;

    new-instance v2, Lgc/b;

    invoke-direct {v2, p1}, Lgc/b;-><init>(Lbd/c;)V

    iget-wide v3, p0, Lpb/l;->g:J

    iget-object v5, p0, Lpb/l;->h:Ljava/util/concurrent/TimeUnit;

    iget-object p1, p0, Lpb/l;->i:Ldb/w;
    ...
    invoke-direct/range {v1 .. v6}, Lpb/l$b;-><init>(Lbd/c;JLjava/util/concurrent/TimeUnit;Ldb/w$c;)V
