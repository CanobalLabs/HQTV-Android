...
.method public static e()Ljava/util/Map;
    ...
    .line 1
    sget-object v0, Lic/b0;->e:Lic/b0;
...
.method public static f(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Lic/g0;->a(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static varargs g([Lkotlin/k;)Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    invoke-static {p0, v0}, Lic/i0;->n([Lkotlin/k;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final h(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lic/h0;->d(Ljava/util/Map;)Ljava/util/Map;
...
.method public static i(Ljava/util/Map;Lkotlin/k;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static final k(Ljava/util/Map;[Lkotlin/k;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
...
.method public static l(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0}, Lic/f0;->b(I)I

    move-result v0

    invoke-direct {v1, v0}, Ljava/util/LinkedHashMap;-><init>(I)V

    invoke-static {p0, v1}, Lic/i0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lic/f0;->c(Lkotlin/k;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lic/i0;->m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    invoke-static {v0}, Lic/i0;->h(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final m(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 1
    invoke-static {p1, p0}, Lic/i0;->j(Ljava/util/Map;Ljava/lang/Iterable;)V

    return-object p1
.end method

.method public static final n([Lkotlin/k;Ljava/util/Map;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<K:",
    ...
    .line 1
    invoke-static {p1, p0}, Lic/i0;->k(Ljava/util/Map;[Lkotlin/k;)V
