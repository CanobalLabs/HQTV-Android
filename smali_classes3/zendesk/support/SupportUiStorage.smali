...
.field private final storage:Ly9/a;


# direct methods
.method public constructor <init>(Ly9/a;Lcom/google/gson/f;)V
    .locals 0
    ...
    .line 2
    iput-object p1, p0, Lzendesk/support/SupportUiStorage;->storage:Ly9/a;
...
.method private static abortEdit(Ly9/a$c;)V
    .locals 4
    ...
    .line 1
    invoke-static {v2, v3, v1}, Lwa/a;->k(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    if-eqz p0, :cond_0

    .line 2
    :try_start_0
    invoke-virtual {p0}, Ly9/a$c;->a()V
    :try_end_0
    ...
    .line 3
    invoke-static {v2, v1, p0, v0}, Lwa/a;->j(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;[Ljava/lang/Object;)V
...
.method private static key(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lya/b;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method public read(Ljava/lang/String;Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lzendesk/support/SupportUiStorage;->storage:Ly9/a;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lzendesk/support/SupportUiStorage;->storage:Ly9/a;
    ...
    .line 5
    invoke-static {p1, p2, v0}, Lwa/a;->k(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public write(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 2
    :try_start_1
    iget-object v2, p0, Lzendesk/support/SupportUiStorage;->storage:Ly9/a;
    ...
    .line 4
    :try_start_2
    invoke-virtual {v0, p1}, Ly9/a$c;->f(I)Ljava/io/OutputStream;
    ...
    invoke-static {v1, p1, p2}, Lzendesk/support/Streams;->toJson(Lcom/google/gson/f;Lokio/Sink;Ljava/lang/Object;)V

    .line 6
    invoke-virtual {v0}, Ly9/a$c;->e()V
    :try_end_2
    .catch Ljava/io/IOException; {:try_start_2 .. :try_end_2} :catch_0
    ...
    .line 8
    :catch_0
    invoke-static {v0}, Lzendesk/support/SupportUiStorage;->abortEdit(Ly9/a$c;)V
