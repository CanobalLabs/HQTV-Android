...
.method extractConfigs(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-static {p1, v0}, Lgd/c;->g(Ljava/util/Map;Ljava/lang/Class;)Lgd/a;
    ...
    .line 2
    invoke-interface {p1}, Lgd/a;->getConfigurations()Ljava/util/List;
...
.method public getActionDescription()Lzendesk/core/ActionDescription;
    ...
    sget v1, Lxa/j;->zs_request_contact_option_leave_a_message:I
    ...
    sget v2, Lxa/e;->zs_contact_leave_message:I
...
.method public handle(Ljava/util/Map;Landroid/content/Context;)V
    ...
    invoke-virtual {p1, p2, v0}, Lzendesk/support/request/RequestConfiguration$Builder;->show(Landroid/content/Context;[Lgd/a;)V
