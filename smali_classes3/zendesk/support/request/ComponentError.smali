...
# direct methods
.method private constructor <init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lhd/f;Lzendesk/support/request/ActionFactory;)V
    .locals 0
    ...
    .line 3
    iput-object p2, p0, Lzendesk/support/request/ComponentError;->dispatcher:Lhd/f;
...
.method static synthetic access$300(Lzendesk/support/request/ComponentError;)Lhd/f;
    .locals 0

    .line 1
    iget-object p0, p0, Lzendesk/support/request/ComponentError;->dispatcher:Lhd/f;

    return-object p0
.end method

.method static create(Landroid/app/Activity;Lhd/f;Lzendesk/support/request/ActionFactory;)Lzendesk/support/request/ComponentError;
    .locals 1

    .line 1
    sget v0, Lxa/f;->activity_request:I
    ...
    invoke-direct {v0, p0, p1, p2}, Lzendesk/support/request/ComponentError;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Lhd/f;Lzendesk/support/request/ActionFactory;)V

    return-object v0
.end method

.method static getSelector()Lhd/p;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public update(Lzendesk/support/request/ComponentError$ErrorStateModel;)V
    ...
    sget v0, Lxa/j;->request_error_create_request:I

    invoke-virtual {p1, v0}, Lcom/google/android/material/snackbar/Snackbar;->B(I)Lcom/google/android/material/snackbar/Snackbar;
    ...
    sget v0, Lxa/j;->request_error_load_comments:I
    ...
    sget v0, Lxa/j;->retry_view_button_label:I
