...
.method static synthetic access$100(Lzendesk/support/request/ActionCreateComment;Lzendesk/support/request/StateConversation;Lzendesk/support/request/StateConfig;Lhd/f;Lzendesk/support/request/AsyncMiddleware$Callback;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p5}, Lzendesk/support/request/ActionCreateComment;->createMessage(Lzendesk/support/request/StateConversation;Lzendesk/support/request/StateConfig;Lhd/f;Lzendesk/support/request/AsyncMiddleware$Callback;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;)V
...
.method private addComment(Lzendesk/support/request/AsyncMiddleware$Callback;Lhd/f;Lzendesk/support/request/StateConversation;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;)V
    .locals 11
...
.method private createMessage(Lzendesk/support/request/StateConversation;Lzendesk/support/request/StateConfig;Lhd/f;Lzendesk/support/request/AsyncMiddleware$Callback;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;)V
    .locals 6
    ...
    invoke-static {v0}, Lya/g;->b(Ljava/lang/String;)Z
    ...
    .line 4
    invoke-static {v3, v0, p2}, Lwa/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 5
    invoke-direct {p0, p4, p3, p1, p5}, Lzendesk/support/request/ActionCreateComment;->addComment(Lzendesk/support/request/AsyncMiddleware$Callback;Lhd/f;Lzendesk/support/request/StateConversation;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;)V
    ...
    invoke-static {v3, v0, p1}, Lwa/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 7
    invoke-direct {p0, p4, p3, p5, p2}, Lzendesk/support/request/ActionCreateComment;->createRequest(Lzendesk/support/request/AsyncMiddleware$Callback;Lhd/f;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;Lzendesk/support/request/StateConfig;)V

    :goto_0
    return-void
.end method

.method private createRequest(Lzendesk/support/request/AsyncMiddleware$Callback;Lhd/f;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;Lzendesk/support/request/StateConfig;)V
    .locals 6
    ...
    invoke-static {v1}, Lya/g;->b(Ljava/lang/String;)Z
    ...
    invoke-direct {v1, p0, p3, p2, p1}, Lzendesk/support/request/ActionCreateComment$3;-><init>(Lzendesk/support/request/ActionCreateComment;Lzendesk/support/request/AttachmentUploadService$AttachmentUploadResult;Lhd/f;Lzendesk/support/request/AsyncMiddleware$Callback;)V
...
.method private waitForAttachments(Lhd/f;Lhd/j;Lzendesk/support/request/AsyncMiddleware$Callback;)V
    .locals 7

    .line 1
    invoke-interface {p2}, Lhd/j;->getState()Lhd/o;

    move-result-object v0

    invoke-static {v0}, Lzendesk/support/request/StateConversation;->fromState(Lhd/o;)Lzendesk/support/request/StateConversation;
    ...
    invoke-static {p2}, Lzendesk/support/request/StateConfig;->fromState(Lhd/o;)Lzendesk/support/request/StateConfig;
    ...
    invoke-static {v0, v1, p2}, Lwa/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-direct/range {v1 .. v6}, Lzendesk/support/request/ActionCreateComment$1;-><init>(Lzendesk/support/request/ActionCreateComment;Lzendesk/support/request/StateConversation;Lzendesk/support/request/StateConfig;Lhd/f;Lzendesk/support/request/AsyncMiddleware$Callback;)V
...
# virtual methods
.method public actionQueued(Lhd/f;Lhd/j;)V
    .locals 4
    ...
    invoke-static {p2}, Lzendesk/support/request/StateConversation;->fromState(Lhd/o;)Lzendesk/support/request/StateConversation;
    ...
    .line 3
    invoke-static {v0}, Lya/a;->i(Ljava/util/Collection;)Z
    ...
    .line 7
    invoke-static {v0, v2, v1}, Lwa/a;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {p2, v0}, Lzendesk/support/request/ActionFactory;->createComment(Lzendesk/support/request/StateMessage;)Lhd/a;
...
.method public execute(Lhd/f;Lhd/j;Lzendesk/support/request/AsyncMiddleware$Callback;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, Lzendesk/support/request/ActionCreateComment;->waitForAttachments(Lhd/f;Lhd/j;Lzendesk/support/request/AsyncMiddleware$Callback;)V
