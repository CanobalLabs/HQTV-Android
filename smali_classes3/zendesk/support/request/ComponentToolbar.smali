...
.field private final fadeTransition:Lj1/k;
...
# direct methods
.method constructor <init>(Lja/d;Landroidx/appcompat/widget/Toolbar;Lzendesk/support/request/ViewAlmostRealProgressBar;)V
    .locals 1
    ...
    iput-object v0, p0, Lzendesk/support/request/ComponentToolbar;->fadeTransition:Lj1/k;

    .line 3
    iput-object p1, p0, Lzendesk/support/request/ComponentToolbar;->picasso:Lja/d;
    ...
    .line 8
    sget p1, Lxa/f;->activity_request_toolbar_container:I
    ...
    .line 9
    sget p1, Lxa/f;->activity_request_toolbar_custom_title:I
    ...
    .line 10
    sget p1, Lxa/f;->activity_request_toolbar_custom_sub_title:I
    ...
    .line 11
    sget p1, Lxa/f;->activity_request_toolbar_avatar_holder:I
...
.method private updateToolbar(Lzendesk/support/request/ComponentToolbar$ToolbarModel;)V
    ...
    sget v5, Lxa/j;->request_toolbar_last_reply:I
    ...
    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->picasso:Lja/d;

    invoke-virtual {p1}, Lzendesk/support/request/ComponentToolbar$ToolbarModel;->getAvatarUrls()Ljava/util/List;

    move-result-object v4

    invoke-virtual {v2, v3, v4}, Lzendesk/support/request/ViewToolbarAvatar;->setImageUrls(Lja/d;Ljava/util/List;)V

    .line 11
    iget-object v2, p0, Lzendesk/support/request/ComponentToolbar;->toolbar:Landroidx/appcompat/widget/Toolbar;

    iget-object v3, p0, Lzendesk/support/request/ComponentToolbar;->fadeTransition:Lj1/k;

    invoke-static {v2, v3}, Lj1/h0;->b(Landroid/view/ViewGroup;Lj1/e0;)V
    ...
    sget v3, Lxa/j;->zs_request_toolbar_accessibility:I
    ...
    sget v0, Lxa/j;->request_activity_title:I
