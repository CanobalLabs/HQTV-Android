...
.method constructor <init>(Landroid/content/Context;Lja/d;Lzendesk/support/request/ActionFactory;Lhd/f;)V
    .locals 0
    ...
    .line 4
    iput-object p4, p0, Lzendesk/support/request/CellBindHelper;->dispatcher:Lhd/f;

    .line 5
    new-instance p3, Lzendesk/support/request/CellAttachmentLoadingUtil;

    invoke-direct {p3, p2, p1}, Lzendesk/support/request/CellAttachmentLoadingUtil;-><init>(Lja/d;Landroid/content/Context;)V
    ...
    .line 6
    sget p2, Lxa/j;->request_message_date_today:I
    ...
    .line 7
    sget p2, Lxa/j;->request_message_date_yesterday:I
...
.method static synthetic access$300(Lzendesk/support/request/CellBindHelper;)Lhd/f;
    .locals 0

    .line 1
    iget-object p0, p0, Lzendesk/support/request/CellBindHelper;->dispatcher:Lhd/f;
...
.method addOnClickListenerForFileAttachment(Landroid/view/View;Lzendesk/support/request/StateRequestAttachment;)V
    ...
    sget v0, Lxa/g;->zs_request_file_attachment_downloading_cell_alpha:I
...
.method bindStatusLabel(Landroid/widget/TextView;ZZ)V
    ...
    .line 1
    sget v0, Lxa/c;->zs_request_cell_label_color_error:I

    .line 2
    sget p2, Lxa/j;->request_messages_status_error:I
    ...
    .line 3
    sget v0, Lxa/c;->zs_request_cell_label_color:I

    .line 4
    sget p2, Lxa/j;->request_message_status_delivered:I
    ...
    .line 11
    invoke-static {p3, p3, v2, v0}, Lq0/b;->a(FFFF)Landroid/view/animation/Interpolator;
...
.method colorForError(Z)I
    ...
    .line 1
    sget p1, Lxa/c;->zs_request_user_background_color_error:I

    goto :goto_0

    .line 2
    :cond_0
    sget p1, Lxa/c;->zs_request_user_background_color:I
...
.method colorForErrorImage(Z)I
    ...
    sget v0, Lxa/c;->zs_request_user_background_image_color_error:I
