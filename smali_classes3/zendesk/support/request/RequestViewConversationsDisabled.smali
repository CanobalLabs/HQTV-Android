...
.method private bindAttachmentCarousel(Lhd/q;Lzendesk/support/request/ActionFactory;)Lhd/t;
    .locals 10

    .line 1
    iget-object v0, p0, Lzendesk/support/request/RequestViewConversationsDisabled;->activity:Landroidx/appcompat/app/c;

    sget v1, Lxa/f;->request_attachment_carousel:I
    ...
    iget-object v2, p0, Lzendesk/support/request/RequestViewConversationsDisabled;->picasso:Lja/d;

    invoke-direct {v8, v1, v2, p2, p1}, Lzendesk/support/request/AdapterAttachmentCarousel;-><init>(Lzendesk/support/request/AttachmentHelper;Lja/d;Lzendesk/support/request/ActionFactory;Lhd/f;)V
    ...
    invoke-direct/range {v1 .. v7}, Lzendesk/support/request/ComponentAttachmentCarousel;-><init>(Lhd/f;Lzendesk/support/request/ActionFactory;Lzendesk/belvedere/e;Landroidx/appcompat/app/c;Lzendesk/support/request/AttachmentHelper;Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    .line 7
    invoke-virtual {v9}, Lzendesk/support/request/ComponentAttachmentCarousel;->getSelector()Lhd/p;

    move-result-object p2

    invoke-interface {p1, p2, v9}, Lhd/q;->e(Lhd/p;Lhd/k;)Lhd/t;
...
.method private bindComponents(Lhd/q;Lzendesk/support/request/ActionFactory;)Lhd/t;
    .locals 3
    ...
    .line 1
    invoke-direct {p0, p1}, Lzendesk/support/request/RequestViewConversationsDisabled;->bindInput(Lhd/q;)Lhd/t;
    ...
    .line 2
    invoke-direct {p0, p1, p2}, Lzendesk/support/request/RequestViewConversationsDisabled;->bindAttachmentCarousel(Lhd/q;Lzendesk/support/request/ActionFactory;)Lhd/t;
...
.method private bindInput(Lhd/q;)Lhd/t;
    .locals 2
    ...
    .line 2
    invoke-static {p0, p1, v0, v1}, Lzendesk/support/request/ComponentInputForm;->create(Landroid/view/View;Lhd/f;Lzendesk/support/request/ActionFactory;Lzendesk/support/request/AttachmentHelper;)Lzendesk/support/request/ComponentInputForm;
    ...
    invoke-virtual {v0}, Lzendesk/support/request/ComponentInputForm;->getSelector()Lhd/p;
...
.method private viewInit(Landroid/content/Context;)V
    ...
    .line 1
    sget v0, Lxa/h;->zs_view_request_conversations_disabled:I
...
.method public inflateMenu(Landroid/view/MenuInflater;Landroid/view/Menu;)Z
    ...
    .line 1
    sget v0, Lxa/i;->zs_view_request_conversations_disabled_menu:I

    invoke-virtual {p1, v0, p2}, Landroid/view/MenuInflater;->inflate(ILandroid/view/Menu;)V

    .line 2
    sget p1, Lxa/f;->request_conversations_disabled_menu_ic_send:I
    ...
    .line 3
    sget v0, Lxa/f;->request_conversations_disabled_menu_ic_add_attachments:I
...
.method public init(Lzendesk/support/request/RequestComponent;)V
    ...
    .line 4
    iget-object p1, p0, Lzendesk/support/request/RequestViewConversationsDisabled;->store:Lhd/q;

    iget-object v0, p0, Lzendesk/support/request/RequestViewConversationsDisabled;->af:Lzendesk/support/request/ActionFactory;

    invoke-direct {p0, p1, v0}, Lzendesk/support/request/RequestViewConversationsDisabled;->bindComponents(Lhd/q;Lzendesk/support/request/ActionFactory;)Lhd/t;

    move-result-object p1

    iput-object p1, p0, Lzendesk/support/request/RequestViewConversationsDisabled;->subscription:Lhd/t;
...
.method protected onDetachedFromWindow()V
    ...
    .line 2
    iget-object v0, p0, Lzendesk/support/request/RequestViewConversationsDisabled;->subscription:Lhd/t;
