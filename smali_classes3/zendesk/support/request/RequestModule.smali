...
# instance fields
.field private final configuration:Lgd/a;
...
.method constructor <init>(Lgd/a;)V
    ...
    .line 2
    iput-object p1, p0, Lzendesk/support/request/RequestModule;->configuration:Lgd/a;
...
.method static providesAttachmentDownloaderComponent(Lhd/f;Lzendesk/support/request/ActionFactory;Lzendesk/support/request/AttachmentDownloaderComponent$AttachmentDownloader;)Lzendesk/support/request/AttachmentDownloaderComponent;
    .locals 1

    .line 1
    new-instance v0, Lzendesk/support/request/AttachmentDownloaderComponent;

    invoke-direct {v0, p0, p1, p2}, Lzendesk/support/request/AttachmentDownloaderComponent;-><init>(Lhd/f;Lzendesk/support/request/ActionFactory;Lzendesk/support/request/AttachmentDownloaderComponent$AttachmentDownloader;)V
...
.method static providesDispatcher(Lhd/q;)Lhd/f;
    .locals 0
...
.method static providesStore(Ljava/util/List;Lzendesk/support/request/AsyncMiddleware;)Lhd/q;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0}, Lhd/r;->b(Ljava/util/Collection;)Lhd/r$a;

    move-result-object p0

    const/4 v0, 0x1

    new-array v0, v0, [Lhd/m;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lhd/r$a;->e([Lhd/m;)Lhd/r$a;

    sget-object p1, Lhd/i;->b:Lhd/h;

    .line 3
    invoke-virtual {p0, p1}, Lhd/r$a;->d(Lhd/h;)Lhd/r$a;

    .line 4
    invoke-virtual {p0}, Lhd/r$a;->b()Lhd/q;
...
# virtual methods
.method providesMessageFactory(Landroid/content/Context;Lja/d;Lzendesk/support/request/ActionFactory;Lhd/f;Lzendesk/support/ZendeskDeepLinkHelper;)Lzendesk/support/request/CellFactory;
    .locals 8
    ...
    iget-object v6, p0, Lzendesk/support/request/RequestModule;->configuration:Lgd/a;
    ...
    invoke-direct/range {v0 .. v6}, Lzendesk/support/request/CellFactory;-><init>(Landroid/content/Context;Lja/d;Lzendesk/support/request/ActionFactory;Lhd/f;Lzendesk/support/ZendeskDeepLinkHelper;Lgd/a;)V
