...
# direct methods
.method constructor <init>(Landroidx/appcompat/app/c;Lzendesk/belvedere/e;Lzendesk/support/request/ViewMessageComposer;Lhd/f;Lzendesk/support/request/ActionFactory;)V
    .locals 0
    ...
    .line 4
    iput-object p4, p0, Lzendesk/support/request/ComponentMessageComposer;->dispatcher:Lhd/f;
    ...
    sget p4, Lxa/f;->attachments_indicator_icon:I

    const/4 p5, 0x0

    aput p4, p2, p5

    sget p4, Lxa/f;->message_composer_send_btn:I
...
.method private initImagePicker()V
    ...
    invoke-virtual {v0, p0}, Lzendesk/belvedere/e;->o(Lzendesk/belvedere/e$b;)V
...
# virtual methods
.method public getSelector()Lhd/p;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public onAddAttachmentsRequested()V
    ...
    invoke-virtual {v0}, Lzendesk/belvedere/e;->s()Z
...
.method public onMediaDeselected(Ljava/util/List;)V
    ...
    .line 1
    iget-object v0, p0, Lzendesk/support/request/ComponentMessageComposer;->dispatcher:Lhd/f;

    iget-object v1, p0, Lzendesk/support/request/ComponentMessageComposer;->actionFactory:Lzendesk/support/request/ActionFactory;

    invoke-virtual {v1, p1}, Lzendesk/support/request/ActionFactory;->deselectAttachment(Ljava/util/List;)Lhd/a;
...
.method public onMediaSelected(Ljava/util/List;)V
    ...
    invoke-virtual {v1, p1}, Lzendesk/support/request/ActionFactory;->selectAttachment(Ljava/util/List;)Lhd/a;
...
.method public onSendMessageRequested(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, p1, v2}, Lzendesk/support/request/ActionFactory;->createCommentAsync(Ljava/lang/String;Ljava/util/List;)Lhd/a;
    ...
    .line 4
    iget-object p1, p0, Lzendesk/support/request/ComponentMessageComposer;->dispatcher:Lhd/f;

    iget-object v0, p0, Lzendesk/support/request/ComponentMessageComposer;->actionFactory:Lzendesk/support/request/ActionFactory;

    invoke-virtual {v0}, Lzendesk/support/request/ActionFactory;->clearAttachments()Lhd/a;

    move-result-object v0

    invoke-interface {p1, v0}, Lhd/f;->d(Lhd/a;)V
    ...
    invoke-virtual {v0}, Lzendesk/support/request/ActionFactory;->updateCommentsAsync()Lhd/a;
