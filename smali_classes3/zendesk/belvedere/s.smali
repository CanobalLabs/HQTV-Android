...
.method private h(Landroid/content/Context;)Z
    ...
    invoke-direct {p0, v1, v2, v0}, Lzendesk/belvedere/s;->d(Ljava/lang/String;ZLjava/util/List;)Landroid/content/Intent;
...
.method private j(Landroid/content/Context;I)Ln0/d;
    .locals 20
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v1}, Lzendesk/belvedere/r;->e()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lzendesk/belvedere/r;->l()J

    move-result-wide v11

    invoke-virtual {v1}, Lzendesk/belvedere/r;->d()J
    ...
    invoke-direct {v2, v3, v1}, Ln0/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method c(I)Ln0/d;
    ...
    invoke-direct {p0, v0, p1}, Lzendesk/belvedere/s;->j(Landroid/content/Context;I)Ln0/d;
    ...
    invoke-direct {p1, v0, v1}, Ln0/d;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method e(Landroid/content/Context;IILandroid/content/Intent;Lzendesk/belvedere/d;Z)V
    ...
    .line 3
    invoke-virtual {v6}, Lzendesk/belvedere/r;->c()Ljava/io/File;
    ...
    invoke-virtual {v6}, Lzendesk/belvedere/r;->k()Landroid/net/Uri;
    ...
    invoke-static {v11, v7}, Lzendesk/belvedere/p;->a(Ljava/lang/String;Ljava/lang/String;)V

    const/4 v7, 0x3

    .line 5
    iget-object v12, v0, Lzendesk/belvedere/s;->a:Lzendesk/belvedere/y;

    invoke-virtual {v6}, Lzendesk/belvedere/r;->k()Landroid/net/Uri;

    move-result-object v13

    invoke-virtual {v12, v1, v13, v7}, Lzendesk/belvedere/y;->m(Landroid/content/Context;Landroid/net/Uri;I)V
    ...
    invoke-virtual {v6}, Lzendesk/belvedere/r;->i()Landroid/net/Uri;

    move-result-object v15

    invoke-virtual {v6}, Lzendesk/belvedere/r;->f()Ljava/lang/String;
    ...
    .line 11
    invoke-direct {v0, v2}, Lzendesk/belvedere/s;->b(Landroid/content/Intent;)Ljava/util/List;
    ...
    invoke-static {v11, v3}, Lzendesk/belvedere/p;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v3, v4, v2}, Lzendesk/belvedere/x;->c(Landroid/content/Context;Lzendesk/belvedere/y;Lzendesk/belvedere/d;Ljava/util/List;)V
...
.method f(ILjava/lang/String;ZLjava/util/List;)Lzendesk/belvedere/q;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .line 3
    invoke-direct {p0, p2, p3, p4}, Lzendesk/belvedere/s;->d(Ljava/lang/String;ZLjava/util/List;)Landroid/content/Intent;
