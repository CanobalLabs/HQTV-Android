...
.method private constructor <init>()V
    ...
    const-string v0, "!SDK-VERSION-STRING!:com.ironsource:mediationsdk:\u200b7.1.0.2"
...
.method private varargs declared-synchronized attachAdUnits(Z[Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    ...
    invoke-direct {p2, v2, p1}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
...
.method private getCachedResponse(Landroid/content/Context;Ljava/lang/String;)Lcom/ironsource/mediationsdk/utils/ServerResponseWrapper;
    ...
    invoke-direct {v0, v1, p1}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p1, v0}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method private prepareEventManagers(Landroid/app/Activity;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->start(Landroid/content/Context;Lcom/ironsource/mediationsdk/IronSourceSegment;)V
...
.method private sentEventWithISEventManager(ILorg/json/JSONObject;)V
    ...
    invoke-direct {v0, p1, p2}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
...
.method public addImpressionDataListener(Lcom/ironsource/mediationsdk/impressionData/ImpressionDataListener;)V
    ...
    .line 4
    invoke-interface {v0, p1}, Lcom/ironsource/mediationsdk/IProgManager;->addImpressionDataListener(Lcom/ironsource/mediationsdk/impressionData/ImpressionDataListener;)V
    ...
    .line 6
    invoke-virtual {v0, p1}, Lcom/ironsource/mediationsdk/BaseProgManager;->addImpressionDataListener(Lcom/ironsource/mediationsdk/impressionData/ImpressionDataListener;)V
...
.method public getISDemandOnlyBiddingData()Ljava/lang/String;
    ...
    invoke-virtual {v0, v2}, Lcom/ironsource/mediationsdk/model/ProviderSettingsHolder;->getProviderSettings(Ljava/lang/String;)Lcom/ironsource/mediationsdk/model/ProviderSettings;
    ...
    invoke-virtual {v0}, Lcom/ironsource/mediationsdk/model/ProviderSettings;->getApplicationSettings()Lorg/json/JSONObject;

    move-result-object v4

    const/4 v5, 0x1

    invoke-virtual {v3, v0, v4, v5}, Lcom/ironsource/mediationsdk/AdapterRepository;->getAdapter(Lcom/ironsource/mediationsdk/model/ProviderSettings;Lorg/json/JSONObject;Z)Lcom/ironsource/mediationsdk/AbstractAdapter;
    ...
    invoke-virtual {v0}, Lcom/ironsource/mediationsdk/utils/TokenSettings;->getGenericParams()Lorg/json/JSONObject;

    move-result-object v4

    invoke-virtual {v0}, Lcom/ironsource/mediationsdk/utils/TokenSettings;->getOptInKeyParamsTokenArray()Ljava/util/ArrayList;

    move-result-object v0

    invoke-virtual {v3, v2, v4, v0}, Lcom/ironsource/mediationsdk/AuctionDataUtils;->createToken(Lorg/json/JSONObject;Lorg/json/JSONObject;Ljava/util/List;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v2, v0}, Lcom/ironsource/mediationsdk/AuctionDataUtils;->encryptToken(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    .line 12
    invoke-direct {p0, v2, v1}, Lcom/ironsource/mediationsdk/IronSourceObject;->sentEventWithRVEventManager(ILorg/json/JSONObject;)V
...
.method public varargs declared-synchronized init(Landroid/app/Activity;Ljava/lang/String;Z[Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/mediationsdk/utils/IronSourceUtils;->setBrowserUserAgent()V
    ...
    .line 28
    iget-object v3, p0, Lcom/ironsource/mediationsdk/IronSourceObject;->mAppKey:Ljava/lang/String;
    ...
    invoke-direct {v0, v2, p3}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p3, v0}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method public varargs declared-synchronized initISDemandOnly(Landroid/app/Activity;Ljava/lang/String;[Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    ...
    :cond_7
    :goto_4
    iget-boolean p3, p0, Lcom/ironsource/mediationsdk/IronSourceObject;->mDidInitRewardedVideo:Z
    ...
    invoke-direct {p0, p3}, Lcom/ironsource/mediationsdk/IronSourceObject;->sendAdUnitAlreadyInitializedLog(Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    ...
    .line 22
    :goto_5
    iget-boolean p3, p0, Lcom/ironsource/mediationsdk/IronSourceObject;->mDidInitInterstitial:Z
    ...
    invoke-virtual {p3, p1}, Lcom/ironsource/mediationsdk/utils/ContextProvider;->updateActivity(Landroid/app/Activity;)V
    ...
    .line 30
    invoke-virtual {p0, p1, p2, v1, p3}, Lcom/ironsource/mediationsdk/IronSourceObject;->init(Landroid/app/Activity;Ljava/lang/String;Z[Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method isInterstitialPlacementCapped(Ljava/lang/String;)Z
    ...
    invoke-direct {p1, v2, v0}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {v0, p1}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method public isInterstitialReady()Z
    ...
    :goto_2
    invoke-direct {v5, v6, v4}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {v4, v5}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method public loadInterstitial()V
    ...
    invoke-virtual {v3, v5, v0, v4}, Lcom/ironsource/mediationsdk/logger/IronSourceLoggerManager;->log(Lcom/ironsource/mediationsdk/logger/IronSourceLogger$IronSourceTag;Ljava/lang/String;I)V
    ...
    invoke-virtual {v3, v0}, Lcom/ironsource/mediationsdk/CallbackThrottler;->onInterstitialAdLoadFailed(Lcom/ironsource/mediationsdk/logger/IronSourceError;)V
    ...
    invoke-virtual {v0, v3, v6, v4}, Lcom/ironsource/mediationsdk/logger/IronSourceLoggerManager;->log(Lcom/ironsource/mediationsdk/logger/IronSourceLogger$IronSourceTag;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0, v3, v5, v4}, Lcom/ironsource/mediationsdk/logger/IronSourceLoggerManager;->log(Lcom/ironsource/mediationsdk/logger/IronSourceLogger$IronSourceTag;Ljava/lang/String;I)V
...
.method public onInitSuccess(Ljava/util/List;Z)V
    ...
    invoke-direct {v0, v2, p2}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p2, v0}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method public removeAllImpressionDataListeners()V
    ...
    .line 4
    invoke-interface {v0}, Lcom/ironsource/mediationsdk/IProgManager;->removeAllImpressionDataListeners()V
    ...
    .line 6
    invoke-virtual {v0}, Lcom/ironsource/mediationsdk/BaseProgManager;->removeAllImpressionDataListeners()V
...
.method public removeImpressionDataListener(Lcom/ironsource/mediationsdk/impressionData/ImpressionDataListener;)V
    ...
    .line 4
    invoke-interface {v0, p1}, Lcom/ironsource/mediationsdk/IProgManager;->removeImpressionDataListener(Lcom/ironsource/mediationsdk/impressionData/ImpressionDataListener;)V
    ...
    .line 6
    invoke-virtual {v0, p1}, Lcom/ironsource/mediationsdk/BaseProgManager;->removeImpressionDataListener(Lcom/ironsource/mediationsdk/impressionData/ImpressionDataListener;)V
...
.method public sendInitCompletedEvent(J)V
    ...
    invoke-direct {p1, p2, v0}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p2, p1}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method public setConsent(Z)V
    ...
    invoke-direct {v1, v0, p1}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {p1, v1}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method public setDynamicUserId(Ljava/lang/String;)Z
    ...
    invoke-direct {v4, v5, v3}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {v3, v4}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
...
.method setIronSourceUserId(Ljava/lang/String;Z)V
    ...
    invoke-direct {p2, v0, p1}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
...
.method public showInterstitial(Ljava/lang/String;)V
    ...
    invoke-direct {p1, v4, v3}, Lh9/b;-><init>(ILorg/json/JSONObject;)V
    ...
    invoke-virtual {v3, p1}, Lcom/ironsource/mediationsdk/events/BaseEventsManager;->log(Lh9/b;)V
