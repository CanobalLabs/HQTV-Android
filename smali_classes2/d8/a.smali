...
.method public static final a()Ld8/b;
    .locals 2

    .line 1
    sget-object v0, Ld8/a;->a:Ld8/r0;

    if-eqz v0, :cond_1

    invoke-interface {v0}, Ld8/r0;->c()Ld8/s0;
    ...
    const-string v1, "null cannot be cast to non-null type com.intermedia.injection.ApplicationComponent"
